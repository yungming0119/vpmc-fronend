...
import {GeoJson} from "@/lib/LayerManage/CustomProcessor"
...
[
    ...
    },
    {
        name:'捷運路線',
        type:'GeoJson',
        payload: { url:'http://cm.nadi3docms.com/GIS_WebApp/DEMO/DataSource/GeoJson/MRT_Routes.geojson' },
        processor: GeoJson.processor,
    },
]
